...
class View:
    ...
    def __init__(self, page):
        ...
        self._page.horizontal_alignment = "CENTER"   # allinea tutti gli elementi grafici rispetto alla mezzeria
    ...
    def carica_interfaccia(self):
        ...
        row2 = ft.Row(controls=[self._txtInNomeC, self._txtInEmail, self._txtInCategoria],
                      alignment=ft.MainAxisAlignment.CENTER)

        # Buttons
        self._btnAdd = ft.ElevatedButton(text="Aggiungi ordine",
                                         on_click=self._controller.add_ordine,   # ATTENZIONE NOME FUNZIONE E NON CHIAMATA ALLA FUNZIONE
                                         width=200)
        ...
        # Aggiungo la finestra di testo per comunicare con l'utente
        self._lvOut = ft.ListView(expand=True)

        # Aggiungo righe e finestra di testo alla pagina
